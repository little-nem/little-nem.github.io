...
\begin{tikzpicture}[>=stealth']
    ...
    \begin{scope}[on background layer]
        ...
        %\fill [blue, opacity=0.4] plot [smooth cycle, tension=0.7] coordinates {($ (24) + (0.4,0)$) ($ (24) + (0,-0.4)$) ($ (24) + (-0.4, 0)$) ($ (24) + (0,0.4)$)};
        %\fill [blue, opacity=0.4] plot [smooth cycle, tension=0.7] coordinates {($ (25) + (0.4,0)$) ($ (25) + (0,-0.4)$) ($ (25) + (-0.4, 0)$) ($ (25) + (0,0.4)$)};
